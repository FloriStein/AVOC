...
|----|------|-----|-------------|--------|---------|
| DRIFT-K1 | ADR-009 „Auth Invalidation" (JWT-Widerruf→SAFE_MODE) ohne Produktivpfad — Grill-Me vor Fix | L | Kritisch | 🔲 Grill-Me ausstehend | `EventAuthInvalid` nur in Unit-Test erzeugt |
| DRIFT-K2 | ADR-009 „No Active Operator" ohne Produktivpfad — Grill-Me vor Fix | L | Kritisch | 🔲 Grill-Me ausstehend | Effekt entsteht zufällig über WS-Disconnect, OPERATOR-Layer selbst greift nicht |
| DRIFT-K3 | DEGRADED-Tier (Media/Video/Telemetrie) komplett unverdrahtet — Grill-Me vor Fix | L | Kritisch | 🔲 Grill-Me ausstehend | `TransitionMedia(...)` nie produktiv aufgerufen |
