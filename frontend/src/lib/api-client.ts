...
// internal/fleetservice/store.go's Station/Task exactly (see FleetVehicle's comment above for
// why this matters: the Go struct's `omitempty`/pointer-ness is the actual contract, not a guess).
