...
describe('ControlPanel', () => {
  it('zeigt Input-Anzeige', () => {
    render(<ControlPanel wsClient={null} sessionId={null} vehicleId={null} operatorId={null} enabled={true} />)
  ...
  it('zeigt Joystick SVG', () => {
    const { container } = render(<ControlPanel wsClient={null} sessionId={null} vehicleId={null} operatorId={null} enabled={true} />)
    expect(container.querySelector('svg')).toBeInTheDocument()
  })

  it('disabled-Zustand setzt opacity-Klasse', () => {
    const { container } = render(<ControlPanel wsClient={null} sessionId={null} vehicleId={null} operatorId={null} enabled={false} />)
