...
Vorgänger: Sprint 49 ✅ (Lokale Ansible-VM als Hetzner-Nachbildung, Teil B: Verifikation, siehe
`tasks/sprints/49-lokale-ansible-vm-teil-b.md`) — damit ist das EPIC "Lokale Ansible-VM als
Hetzner-Nachbildung (AWS-Ersatz für die Testumgebung)" vollständig abgeschlossen (Teil A
Sprint 48, Teil B Sprint 49), siehe `tasks/backlog.md`.
